...
parameterObj.m1 = 0.01;
parameterObj.m2 = 0.05;
parameterObj.m3 = 0.1;
parameterObj.eta = 1e-4;
parameterObj.T = 1; %max{ 0.1(fx1-fopt),1}
parameterObj.gammaI = 0.1;
parameterObj.thresholdT = 0.1;
parameterObj.maxBundleSize = 19;
...
parameterObj.auxTol = 1e-4;
parameterObj.breakCondition ='test alpha';
